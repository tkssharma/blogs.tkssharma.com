---
date: 2020-03-13
title: 'Angular chat sheet | Quick Recap'
template: post
thumbnail: '../thumbnails/angular.png'
slug: angular-chat-sheet-quick-recap
categories:
  - Popular
  - Angular
tags:
...
Bootstraps the app, using the root component from the specified [NgModule](https://angular.io/api/core/NgModule).
...
* Removes or recreates a portion of the DOM tree based on the showSection expression
    ...
    import { [CommonModule](https://angular.io/api/common/CommonModule) } from '@angular/common';

    <section *ngIf = "showHeroDetails">
...
* Conditionally swaps the content of the div by selecting one of the embedded templates based on the current value of switch_expression.
    ...
    <div [[ngSwitch](https://angular.io/api/common/NgSwitch)]="switch_expression">
    <ng-template [ngSwitchCase](https://angular.io/api/common/NgSwitchCase) = "match_expression_1">...</ng-template>
    <ng-template ngSwitchCase = "match_expression_2">...</ng-template>
...
* Declares an input property that you can update via property binding (example: <my-cmp [myProperty]="someExpression">).
    ...
    import { [Input](https://angular.io/api/core/Input) } from '@angular/core';
...
* It declares a DOM event to listen for and provides a handler method to run when that event occurs. Subscribes to a host element event (click) with a directive/component method (onClick), optionally passing an argument ($event).
    ...
    @[HostListener](https://angular.io/api/core/HostListener)('click', ['$event']) onClick(e) {...}
