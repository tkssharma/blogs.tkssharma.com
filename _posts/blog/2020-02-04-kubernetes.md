---
date: 2019-12-23
title: 'Kubernetes Architecture | K8S DevOps'
template: post
thumbnail: '../thumbnails/k8s.png'
slug: kubernetes_architecture
categories:
  - DevOps
tags:
  - Kubernetes
...
<img class="cp t u fy ak" src="https://miro.medium.com/max/1144/0*AM3px3r4wAKzi9wZ.png" width="572" height="549" role="presentation"/>
...
*   **Node:** A worker machine in Kubernetes. Maybe a VM or a physical machine, and comes with services necessary to run _Pods_.
...
*   **Selectors:** The core grouping primitive in Kubernetes. Label selectors enable grouping or managing of objects via their _labels_.
